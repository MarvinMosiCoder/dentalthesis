            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 col-lg-8 col-xl-6">
                    <div class="row">
                        ...
                        <form method="post" class="form-auth-small" id="frm_data" action="actions/insert.php">
                            <div class="col text-center">
                                <h1>add appointment</h1>

                                <p class="text-h3">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean
                                    commodo ligula eget dolor. </p>
                            </div>
                    </div>
                    <div class="row d-flex align-items-center mt-4">

                        <input type="hidden" name="client_id" id="client_id" value="<?php echo $user_id;?>"
                    ...
                    <div class="row align-items-center mt-4">
                        <div class="col">
                            <input type="time" name="time_of_appointment" id="time_of_appointment" class="form-control"
...
$(document).ready(function() {
    ...
    //     if ($.trim(treatment_type).length > 0 && $.trim(date_of_appointment).length > 0 && $.trim(
    //             time_of_appoinment).length > 0) {
